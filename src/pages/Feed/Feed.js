  ...
  finishEditHandler = (postData) => {
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then((fileResData) => {
        ...
        let graphqlQuery = {
          query: `
            mutation CreatePost($postTitle: String!, $postContent: String!, $postImage: String!) {
      ...
      .then((resData) => {
        ...
        if (
          resData.errors &&
          (resData.errors[0].status !== 200 || resData.errors[0].status !== 201)
        ) {
        ...
        this.setState((prevState) => {
          ...
          if (prevState.editPost) {
            const postIndex = prevState.posts.findIndex((p) => p._id === prevState._id);
